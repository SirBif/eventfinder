...
function retrieveEventsToDisplay(){
    return extractFromDb("SELECT name, start_date AS start_time, attending_total, maybe_total, location FROM events ORDER BY start_date ASC LIMIT 5");
}
...
function updateEventInfo(eventData) {
    var query = "UPDATE events SET end_date=$1, attending_total=$2, maybe_total=$3, latitude=$4, longitude=$5, location=$6, name=$7 WHERE eid = $8;";
